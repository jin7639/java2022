...
public class Orderdetail {
	...
	public String toString() {
		return "Orderdetail [orderdetailno=" + orderdetailno + ", orderdetailactive=" + orderdetailactive + ", sno="
				+ sno + ", samount=" + samount + ", totalprice=" + totalprice + ", orderno=" + orderno + "]";
	}
	public Orderdetail() {
		super();
	}
	public Orderdetail(int orderdetailno, int orderdetailactive, int sno, int samount, int totalprice, int orderno) {
		super();

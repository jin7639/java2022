...
public class Day19_3 {
	public static void main(String[] args) {
		...
		//Map 컬렉션 : 키 Set와 값 List으로 이루어진 엔트리를 여러개 저장 [ 순서 X]
		...
		//4.map객체명.get(키) : map객체내 키->값호출
		System.out.println("map 객체 내 값 호출 (키호출시->값호출)" + map.get("유재석"));

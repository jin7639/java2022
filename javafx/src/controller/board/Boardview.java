...
//    			게시물 클릭시 → 날짜 저장
//    			어디에 저장하지?
//    				게시물 번호 | 아이디 | 게시물 클릭 날짜 —→ 오 이렇게 저장하면 될듯?
//    				근데 이걸 어떻게 저장하지?
//    				파일처리해야하나?
//    			오늘날짜랑 게시물 클릭 날짜랑 비교해서 다르면 게시물(번호)에 조회수 +1
//    			같으면 그냥 게시물 조회
    	
    	//현재 날짜 가져오기
    	SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd");
    	String viewdate = dateformat.format(new Date()); //현재날짜를 형식 변환
		
		try {//예외[오류]가 발생할 것 같은 코드 묶음
